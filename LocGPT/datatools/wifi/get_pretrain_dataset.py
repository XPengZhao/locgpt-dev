...
confpath = "conf/pretrain/pretrain-exp4.yaml"
datapath = "data/wifi/"
...
if __name__ == '__main__':
    ...
    for scene in train_scenes:
        ...
        all_data = all_data[..., :5+9*36*3]
        gateway_ind = int(scene[1:]) - 1
        all_gateway_pos = torch.tensor(gateway_pos[gateway_ind]).view(-1)[:9] #[9]
    ...
    torch.save(trainset, f"{savepath}train_data-wifi-exp4-seq1-normgateway.pt")
